...
PROC MCMC data = hiv nbi = 7500 nmc = 250000 thin = 10 plots = all DIC seed = 204;
	PARMS betaint 0 betaLEU3N 0 betadrugs 0 betaage 0 betabmi 0 betaadh 0
		...
		betaeduc 0;
	PARMS sigma2 1;
	PRIOR betaLEU3N betaage betabmi betaadh betarace
		betadrink betasmoke betamarij betaincmed betainchigh betaeduc betaint betadrugs ~ normal(mean = 0, var = 10000);
	PRIOR sigma2 ~ igamma(shape = 2.001, scale = 1.001);
...
PROC MCMC data = hiv nbi = 7500 nmc = 250000 thin = 10 plots = all DIC seed = 204;
	...
	PARMS sigma2 1;
	PRIOR betaLEU3N betaage betabmi betaadh betarace
		betasmoke betamarij betaincmed betainchigh betaeduc betaint betadrugs ~ normal(mean = 0, var = 10000);
	PRIOR sigma2 ~ igamma(shape = 2.001, scale = 1.001);
	mu = betaint + betaLEU3N*LEU3N + betadrugs*harddrugsY + betaage*age +
...
PROC MCMC data = hiv nbi = 7500 nmc = 250000 thin = 10 plots = all DIC seed = 204;
	...
	PARMS sigma2 1;
	PRIOR betaLEU3N betaage betabmi betaadh betarace
		betadrink betamarij betaincmed betainchigh betaeduc betaint betadrugs ~ normal(mean = 0, var = 10000);
	PRIOR sigma2 ~ igamma(shape = 2.001, scale = 1.001);
	mu = betaint + betaLEU3N*LEU3N + betadrugs*harddrugsY + betaage*age +
		betabmi*BMI + betaadh*adhhigh + betarace*raceNHW + betadrink*drink13plus +
...
PROC MCMC data = hiv nbi = 7500 nmc = 250000 thin = 10 plots = all DIC seed = 204;
	...
	PARMS sigma2 1;
	PRIOR betaLEU3N betaage betabmi betaadh betarace
		betadrink betasmoke betaincmed betainchigh betaeduc betaint betadrugs ~ normal(mean = 0, var = 10000);
	PRIOR sigma2 ~ igamma(shape = 2.001, scale = 1.001);
	mu = betaint + betaLEU3N*LEU3N + betadrugs*harddrugsY + betaage*age +
		betabmi*BMI + betaadh*adhhigh + betarace*raceNHW + betadrink*drink13plus +
...
PROC MCMC data = hiv nbi = 7500 nmc = 250000 thin = 10 plots = all DIC seed = 204;
	...
	PARMS sigma2 1;
	PRIOR betaLEU3N betaage betabmi betaadh betarace
		betadrink betasmoke betamarij betaeduc betaint betadrugs ~ normal(mean = 0, var = 10000);
	PRIOR sigma2 ~ igamma(shape = 2.001, scale = 1.001);
	mu = betaint + betaLEU3N*LEU3N + betadrugs*harddrugsY + betaage*age +
		betabmi*BMI + betaadh*adhhigh + betarace*raceNHW + betadrink*drink13plus +
...
PROC MCMC data = hiv nbi = 7500 nmc = 250000 thin = 10 plots = all DIC seed = 204;
	...
	PARMS sigma2 1;
	PRIOR betaLEU3N betaage betabmi betaadh betarace
		betamarij betaincmed betainchigh betaeduc betaint betadrugs ~ normal(mean = 0, var = 10000);
	PRIOR sigma2 ~ igamma(shape = 2.001, scale = 1.001);
	mu = betaint + betaLEU3N*LEU3N + betadrugs*harddrugsY + betaage*age +
		betabmi*BMI + betaadh*adhhigh + betarace*raceNHW +
		betamarij*marijY + betaincmed*incomemed + betainchigh*incomehigh +
...
PROC MCMC data = hiv nbi = 7500 nmc = 250000 thin = 10 plots = all DIC seed = 204;
	...
	PARMS sigma2 1;
	PRIOR betaLEU3N betaage betabmi betaadh betarace
		betamarij betaeduc betaint betadrugs ~ normal(mean = 0, var = 10000);
	PRIOR sigma2 ~ igamma(shape = 2.001, scale = 1.001);
	mu = betaint + betaLEU3N*LEU3N + betadrugs*harddrugsY + betaage*age +
		betabmi*BMI + betaadh*adhhigh + betarace*raceNHW +
...
PROC MCMC data = hiv nbi = 7500 nmc = 250000 thin = 10 plots = all DIC seed = 204;
	...
	PARMS sigma2 1;
	PRIOR betaLEU3N betaage betabmi betaadh betarace
		betamarij betaincmed betainchigh betaint betadrugs ~ normal(mean = 0, var = 10000);
	PRIOR sigma2 ~ igamma(shape = 2.001, scale = 1.001);
	mu = betaint + betaLEU3N*LEU3N + betadrugs*harddrugsY + betaage*age +
		betabmi*BMI + betaadh*adhhigh + betarace*raceNHW +
		betamarij*marijY + betaincmed*incomemed + betainchigh*incomehigh;
...
PROC MCMC data = hiv nbi = 7500 nmc = 250000 thin = 10 plots = all DIC seed = 204;
	...
	PARMS sigma2 1;
	PRIOR betaLEU3N betaage betabmi betaadh betarace
		betaincmed betainchigh betaeduc betaint betadrugs ~ normal(mean = 0, var = 10000);
	PRIOR sigma2 ~ igamma(shape = 2.001, scale = 1.001);
	mu = betaint + betaLEU3N*LEU3N + betadrugs*harddrugsY + betaage*age +
		betabmi*BMI + betaadh*adhhigh + betarace*raceNHW +
...
PROC MCMC data = hiv nbi = 7500 nmc = 250000 thin = 10 plots = all DIC seed = 204;
	...
	PARMS sigma2 1;
	PRIOR betaLEU3N betaage betabmi betaadh betarace
		betaincmed betainchigh betaint betadrugs ~ normal(mean = 0, var = 10000);
	PRIOR sigma2 ~ igamma(shape = 2.001, scale = 1.001);
	mu = betaint + betaLEU3N*LEU3N + betadrugs*harddrugsY + betaage*age +
		betabmi*BMI + betaadh*adhhigh + betarace*raceNHW +
		betaincmed*incomemed + betainchigh*incomehigh;
	model diff_LEU3N ~ normal(mu, var = sigma2);
	title "Full Model of CD4+ count (rem. 4 vars)";
RUN; title;
