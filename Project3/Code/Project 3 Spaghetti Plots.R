...
ggplot(data = blockr[blockr$demind == 1,], aes(x = timeb4dem, y = blockR, group = id)) +
  geom_line() +
  theme_classic() +
  theme(panel.border = element_blank(),
        panel.grid.major = element_blank(),
...
ggplot(data = logmem1[logmem1$demind == 1,], aes(x = timeb4dem, y = logmemI, group = id)) +
  geom_line() +
  theme_classic() +
  theme(panel.border = element_blank(),
        panel.grid.major = element_blank(),
...
ggplot(data = logmem2[logmem2$demind == 1,], aes(x = timeb4dem, y = logmemII, group = id)) +
  geom_line() +
  theme_classic() +
  theme(panel.border = element_blank(),
        panel.grid.major = element_blank(),
